...
plot(dados_HW, ylab = "Energia (kW)", xlab = "Tempo (10s)")
...
dados_forecast <- forecast:::forecast.HoltWinters(dados_HW, h=50)
forecast:::plot.forecast(dados_forecast,ylab = "Energia (kW)", xlab = "Tempo (10s)")
legend("bottomleft",legend=c("Valores reais","Valores previstos"),col=c("black","blue"), lty=c(1,2,3))
